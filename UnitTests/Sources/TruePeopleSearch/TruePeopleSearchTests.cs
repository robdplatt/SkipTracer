...
namespace UnitTests.Sources.TruePeopleSearch;

public class TruePeopleSearchTests
{
    private Source Source { get; } = Source.TruePeopleSearch;
    ...
    public void GetUriByName()
    {
        ...
        Assert.That(Uri[0].AbsoluteUri, Is.EqualTo("https://www.truepeoplesearch.com/results?name=John%20Doe&citystatezip=New%20York,%20NY"));
    }
    ...
    public void GetUriByNumber()
    {
        ...
        var Uri = Searcher.GetUris(Request, Source);
        Assert.That(Uri, Is.Not.Empty);
        Assert.That(Uri[0].AbsoluteUri, Is.EqualTo("https://www.truepeoplesearch.com/resultphone?phoneno=555-555-5555"));
    }

    [Test]
    public void GetUriByAdress()
    {
        var Request = RequestBuilder.CreateRequestByAddress("123 Main St", "New York", "NY");

        var Uri = Searcher.GetUris(Request, Source);
        Assert.That(Uri, Is.Not.Empty);
        Assert.That(Uri[0].AbsoluteUri, Is.EqualTo("https://www.truepeoplesearch.com/resultaddress?streetaddress=123%20Main%20St&citystatezip=New%20York,%20NY"));
    }

    [Test]
    public void TestParser()
    {
        var Html = Properties.Resources.TruePeopleSearchSample;
        var Results = new EFR.SkipTracer.Sources.TruePeopleSearch.Parser().ParseHtml(Html);
